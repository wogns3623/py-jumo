...
Revision ID: d1d1b84846c4
Revises:
Create Date: 2025-09-15 17:00:16.446585
...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column(
            "break_start_time", sqlmodel.sql.sqltypes.AutoString(), nullable=True
        ),
    ...
    op.create_table(
        ...
        sa.Column("is_instant_cook", sa.Boolean(), server_default="0", nullable=False),
        sa.Column("id", sa.Uuid(), nullable=False),
    ...
    op.create_index(
        op.f("ix_menus_restaurant_id"), "menus", ["restaurant_id"], unique=False
    )
    op.create_table(
        "payments",
        sa.Column("id", sa.Uuid(), nullable=False),
    ...
    op.create_index(
        op.f("ix_payments_restaurant_id"), "payments", ["restaurant_id"], unique=False
    )
    op.create_table(
        "tables",
        sa.Column("id", sa.Uuid(), nullable=False),
        ...
        sa.Column("type", sa.Enum("normal", "kiosk", name="tabletype"), nullable=False),
        sa.Column(
            "status",
    ...
    op.create_index(op.f("ix_tables_type"), "tables", ["type"], unique=False)
    op.create_table(
        "waitings",
        sa.Column("id", sa.Uuid(), nullable=False),
        sa.Column("restaurant_id", sa.Uuid(), nullable=False),
    ...
    op.create_index(
        op.f("ix_waitings_restaurant_id"), "waitings", ["restaurant_id"], unique=False
    )
    op.create_table(
        "teams",
        sa.Column("id", sa.Uuid(), nullable=False),
    ...
    op.create_index(
        op.f("ix_teams_restaurant_id"), "teams", ["restaurant_id"], unique=False
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "no",
            sa.Integer(),
            server_default=sa.text("nextval('orders_no_seq')"),
            nullable=True,
        ),
        sa.ForeignKeyConstraint(
            ["payment_id"],
    ...
    op.create_index(
        op.f("ix_orderedmenus_menu_id"), "orderedmenus", ["menu_id"], unique=False
    )
    op.create_index(
        op.f("ix_orderedmenus_order_id"), "orderedmenus", ["order_id"], unique=False
    )
    op.create_index(
        op.f("ix_orderedmenus_restaurant_id"),
        "orderedmenus",
        ["restaurant_id"],
        unique=False,
    )
...
def downgrade():
    ...
    op.drop_index(op.f("ix_tables_type"), table_name="tables")
