...
Revision ID: 5fb04e0b5fa0
Revises: 
Create Date: 2025-08-25 12:50:03.395713
...
def upgrade():
    ...
    sa.ForeignKeyConstraint(['waiting_id'], ['waitings.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    op.create_index(op.f('ix_menuorders_menu_id'), 'menuorders', ['menu_id'], unique=False)
    op.create_index(op.f('ix_menuorders_order_id'), 'menuorders', ['order_id'], unique=False)
