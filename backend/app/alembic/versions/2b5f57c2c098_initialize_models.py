...
Revision ID: 2b5f57c2c098
Revises: 
Create Date: 2025-08-26 03:59:41.541144
...
def upgrade():
    ...
    sa.Column('id', sa.Uuid(), nullable=False),
    sa.Column('restaurant_id', sa.Uuid(), nullable=False),
    sa.Column('no', sa.Integer(), server_default=sa.text("nextval('orders_no_seq')"), nullable=False),
...
def downgrade():
    ...
    op.execute(sa.schema.DropSequence(sa.schema.Sequence('orders_no_seq', increment=1, minvalue=0, start=0, cycle=True)))
